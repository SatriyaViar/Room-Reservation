...
public class RoomReservationBreach2 {
    ...
    public static void PrintForm(String[] resultForm) {
        String[] label = { "| Name: ", "| Alamat: ", "| Email: ",};
        System.out.println("============================================");
        ...
        System.out.println("| Borrowing date: " + borrowDate + ""+borrowMonth);
    ...
    public static String rulesDate(String borrowMonth) {
        if (borrowMonth.equalsIgnoreCase("january")) {
        for (int i = 0; i < January.length; i++) {
            if (borrowMonth.equals(January[i])) {
                isJanuary = true;
                break;
            }
        }
       ...
       if (borrowMonth.equalsIgnoreCase("Febuary")) {
        for (int i = 0; i < Febuary.length; i++) {
            if (borrowMonth.equals(Febuary[i])) {
                isFebuary = true;
                break;
            }
        }
            ...
            switch (optionMenu) {
                ...
                case 3:
                    do {
                        ...
                        System.out.println("|1. Building Graha Polinema                          |");
                        System.out.println("|2. Building Aula Pertamina                          |");
                        System.out.println("|3. building Auditorium Civil Engineering 8th Floor |");
                        System.out.println("|4. Building Graha Teater                            |");
                        System.out.println("|5. Return to Main Menu                              |");
                        System.out.println("======================================================");
                                        ...
                                        if (optionTendik.equalsIgnoreCase("y")) {
                                            ...
                                            do {
                                                ...
                                                if (convertNIP.length() == 18) {
                                                    ...
                                                    totalPayment = (GGraha - discGraha) * loamTerm;
                                                    System.out.println("");
                                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                                    System.out.println("");
                                                } else {
                                                    System.out.println(
                                        ...
                                        if (optionTendik.equalsIgnoreCase("y")) {
                                            ...
                                            do {
                                                ...
                                                if (convertNIP.length() == 18) {
                                                    ...
                                                    PrintForm(resultForm);
                                                    totalPayment = (GPertamina - discPertamina) * loamTerm;
                                                    System.out.println("");
                                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                                    System.out.println("");
                                                } else {
                                            ...
                                            && !optionTendik.equalsIgnoreCase("n"));
                                    PrintForm(resultForm);
                                    totalPayment = GPertamina * loamTerm;
                                    System.out.println("");
                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                    System.out.println("");
                                }
                                        ...
                                        if (optionTendik.equalsIgnoreCase("y")) {
                                            ...
                                            do {
                                                ...
                                                if (convertNIP.length() == 18) {
                                                    ...
                                                    PrintForm(resultForm);
                                                    totalPayment = (GAudit - discAudit ) * loamTerm;
                                                    System.out.println("");
                                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                                    System.out.println("");
                                                } else {
                                        ...
                                        if (optionTendik.equalsIgnoreCase("y")) {
                                            ...
                                            do {
                                                ...
                                                if (convertNIP.length() == 18) {
                                                    ...
                                                    PrintForm(resultForm);
                                                    totalPayment = (GTheater - discTheater) * loamTerm;
                                                    System.out.println("");
                                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                                    System.out.println("");
                                                } else {
                                            ...
                                            && !optionTendik.equalsIgnoreCase("n"));
                                    PrintForm(resultForm);
                                    totalPayment = GTheater * loamTerm;
                                    System.out.println("");
                                    System.out.println("Total Payment: " + totalPayment + "IDR");
                                    System.out.println("");
                                }
